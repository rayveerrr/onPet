...
import { Avatar, Button, Grid, TextField, FormControl, RadioGroup, FormLabel, Radio, FormControlLabel} from '@mui/material';
...
function AddNewEmployee() {
  ...
  const addNewEmployee = async () => {
    try {
        ...
        alert(user)
        await addDoc(userCollectionRef, {Name: name, Email: registerEmail, Gender: gender, PhoneNum: phoneNum, Password: registerPassword, Address: address, UserType: 'Admin' })
    } catch (e) {
